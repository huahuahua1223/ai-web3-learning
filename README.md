...
5. 拒绝 Plan agent 直接 `git push` → 要求人工确认（对齐 AGENTS.md 工作规范）
...
- 打卡 workflow SOP（[AGENTS.md](AGENTS.md)，`CLAUDE.md` 为兼容入口）+ 自动拉打卡原料的 [scripts/wcb-checkin-prep.sh](scripts/wcb-checkin-prep.sh)
...
```
AGENTS.md                 # 仓库级 Agent 权威正文
CLAUDE.md                 # 兼容跳转壳，指向 AGENTS.md
README.md                  # 本文件
profile.md                 # 学员画像
