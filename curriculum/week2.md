...
当前射程：**Dev Tooling 方向**（contract-reader Demo + Hermes 实装 + WCB Agent API 集成经验三块基础）。Week 2 任务对应：
...
5/26 跑 Module A 流程 + 7 问评估框架后再正式锁定主方向。
...
WCB 平台 Week 2 共约 25 个 task（含 9 场直播 + 对应回放 / Co-learning live / 8 个方向研究 + 总交付 + Z.AI Bonus），按完成状态映射（2026-05-25 22:50 基线）：

| 平台任务 | 状态 | 我的 PoW |
|---|---|---|
| Module A · 方向研究｜AI × Web3 问题地图与主方向选择 (+20) | ⏸ 5/26 brainstorm | （5/26 草稿待落） |
...
| Online Session · **5.28 Z.AI 1st 直播 / 回放 / 上麦**（原 5.29 改期）| ⏸ 5/28 20:00 | Module A 核心资源 |
| Online Session · 5.29 Women Builders in AI × Web3 直播 / 回放 | ⏸ | - |
| Online Session · 5.29 Week 2 例会 / 回放 | ⏸ 5/29 20:00 含下周预告 | Weekly Review 任务对应 |
| Z.AI Bonus · Submit 3 Useful Notes | ⏸ 5/28 直播后 | 改期同 Z.AI 主任务 |
| Week 2 Weekly Review · 5.29 例会反思 | ⏸ 待 5/29-30 | 跟 5.29 Week 2 例会捆绑 |

**主方向射程**（待 5/26 框架检验后定）：**Dev Tooling 方向**。三块经验基础：
...
5/26 跑评估框架 7 问 + 6 方向扫描后再正式锁定主方向。
