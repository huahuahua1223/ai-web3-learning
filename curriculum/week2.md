...
按 2026-05-27 WCB 网页任务列表整理：顶部 tab 当前合计 **64** 个 task；其中 `Running 21` 视图里 **Week 2 可见 17 项**，另有 **3 个 Z.AI 相关 task 仍存在于 `program.getById` / `/tmp/wcb-checkin-2026-05-27.md`，但前端当前未显示**。下表优先以网页当前可见任务为准。
...
| Online Session · 5.27 Neo-Cypherpunk Privacy 直播 (+20) | ⏸ | Module F 直接对口 |
...
| Online Session · 5.28 Co-learning Live (+20) | ⏸ | - |
...
以上 3 项来自 `program.getById` 与 `/tmp/wcb-checkin-2026-05-27.md`，但当前网页任务列表未显示，因此这里不把它们算作“当前可直接操作的 UI 任务”。
