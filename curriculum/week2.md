...
- [ ] [GLM 5.1 Agentic Coding Guide](https://docs.z.ai/guides/llm/glm-5.1#agentic-coding) — GLM 5.1 在规划 / 工具调用 / coding 的定位（5.29 Z.AI 直播预读）
...
WCB 平台 Week 2 共 12 个 task，按完成状态映射（2026-05-25 下午基线）：
...
| Online Session · 5.29 Z.AI 直播 / 回放 / 上麦 | ⏸ 待 5/29 | - |
| Week 2 Weekly Review (5.29 反思) | ⏸ 待 5/29-30 | - |
| Z.AI Bonus · Submit 3 Useful Notes | ⏸ 5/29 直播后 | - |
